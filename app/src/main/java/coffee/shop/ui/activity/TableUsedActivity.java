...
public class TableUsedActivity extends AppCompatActivity {

    private static final String TAG = "TableUsed";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_table_used);
    ...
    private void loadTablesUsed() {
        ExecutorService executor = Executors.newSingleThreadExecutor();
        executor.execute(() -> {
            try {
                List<CoffeeTable> fetchedTables = tableController.getAllUsedTables();
...
//    private void onTableClick(CoffeeTable table) {
